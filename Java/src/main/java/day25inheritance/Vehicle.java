...
public class Vehicle {
    ...
    6) super() ve this() ifadeleri constructor içinde herzaman ilk satırda olmalıdır
    7) Bir constructor içinde super() ve this() ifadeleri sadece bir kere kullanılabilir
